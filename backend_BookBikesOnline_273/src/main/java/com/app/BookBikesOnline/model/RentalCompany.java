...
@Table(name = "\"RentalCompany\"", schema =  "\"bookbikesonline\"")
@Data
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"BikeID\""), schema = "\"bookbikesonline\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"CompanyID\""),
            inverseJoinColumns = @JoinColumn( name="\"CustomerID\""), schema = "\"bookbikesonline\"")
